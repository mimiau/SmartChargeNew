...
@RegisterStorage(SmartChargeTest.Shared.class)
public class SmartChargeTest implements StartPoint {
    ...
    public static void main(String[] args) throws IOException {
        ...
        PCJ.deploy(SmartChargeTest.class, nd);
    }
